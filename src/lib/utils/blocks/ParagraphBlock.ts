...
import ParagraphComponent from "../../block-components/ParagraphComponent.vue";
import {registerBlock} from "../registry.ts";

export class ParagraphBlock implements Block {
    component: VueComponent = markRaw(ParagraphComponent);
...
registerBlock(new ParagraphBlock());